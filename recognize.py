...
classifier = cv2.CascadeClassifier(r'D:/AI & ML/Face Detection/Face Detection/haarcascade_frontalface_default.xml')

model = load_model(r"D:/AI & ML/Face Detection/Face Detection/fianl_model.h5")

URL = 'http://192.168.1.10:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Chinu','Sattwik','Biren', 'Lucky','Gyana','Pinki Paglu','Soma Paglu']
    return labels[pred]
